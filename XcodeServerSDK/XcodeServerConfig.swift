...
public struct XcodeServerConfig : JSONSerializable {
    ...
    public func jsonify() -> [String : Any] {
        ...
        dict[Keys.User] = self.user as AnyObject?
        return dict
    }
    ...
    */
    public init(json: [String: Any]) throws {
        ...
        let user = json[Keys.User]
        let password = json[Keys.Password]
        let id = json[Keys.Id]
        try self.init(host: host, user: user as! String?, password: password as! String?, id: id as! RefType?)
    }
}
